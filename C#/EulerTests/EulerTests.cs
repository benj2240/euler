...
namespace EulerTests
{
  ...
  public class EulerTests
  {
    ...
    [TestMethod]
    public void Euler018_Actual()
    {
      Assert.AreEqual(1074, Solutions.Euler018());
    }

    [TestMethod]
    public void Euler019_Actual()
    {
      Assert.AreEqual(171, Solutions.Euler019());
    }

    [TestMethod]
    public void Euler020_Example()
    {
      Assert.AreEqual(27, Solutions.Euler020(10));
    }

    [TestMethod]
    public void Euler020_Actual()
    {
      Assert.AreEqual(648, Solutions.Euler020(100));
    }

    [TestMethod]
    public void Euler021_Actual()
    {
      Assert.AreEqual(31626, Solutions.Euler021(10000));
    }
